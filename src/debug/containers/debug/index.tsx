...
@observer
class Debug extends React.Component<IDebugProps> {
    ...
    private debugOnStart = () => {
        if (this.props.debug.currentTxid) {
            this.props.addLog("Start debugin, Please wait for server response...", "Debug");
            try {
           var f = this.props.debug.startDebug(this.props.debug.currentTxid);
           ...
           console.log(f)
            ...
            this.props.addLog("There is no contract to debug", "Debug");
            console.log();
        }
    }
    ...
    private debugOnStop = () => {
        ...
        this.props.addLog("Stop debuging", "Debug");
    }
